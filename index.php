    ...
    <aside id="header">
        ...
        <nav id="navbar" class="nav-menu">
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link active" href="index.php"><i class="bi bi-house"></i>Inicio</a></li>
                <li class="nav-item"><a class="nav-link" href="acervo.php"><i class="bi bi-book"></i>Acervo</a></li>
            </ul>
        </nav>
    </aside>
    <main id="main">
